...
<div class="container product-page my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>16pt UV Postcards</h1>
            <p>Postcards are a powerful and cost-effective marketing tool, particularly useful as a mailer. Postcards with UV coating offer a shiny, glossy look and feel.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="uv pg 1 only">UV PG 1 Only</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="scoring" class="form-control">
                            ...
                            <option value="score in half">Score In Half</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 14pt UV Postcards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 14pt UV Postcards</h5>
