...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/16pt-aq-business-cards.png') }}" class="img-fluid" alt="18pt Gloss Lamination Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>18pt Matte + Silk Lamination Business Cards</h1>
            <p>These business cards have a silky lamination which also offers better durability.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 18pt Matte Silk Lamination Business Cards</h5>
                    <p><strong>Paper Type:</strong> 95 Bright 16pt C2S Stock (18pt with double sided lamination)</p>
                    <p><strong>Sizes:</strong> 3.5" x 2"</p>
                    <p><strong>Coating:</strong> Gloss Lamination</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 18pt Gloss Lamination Business Cards</h5>
