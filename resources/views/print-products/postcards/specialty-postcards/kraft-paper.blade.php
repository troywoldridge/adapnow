...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/kraft-paper-postcards.png') }}" class="img-fluid" alt="Kraft Paper Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>Kraft Paper Postcards</h1>
            <p>Kraft paper postcard printing on 100% recycled kraft cardstock produces an eco-friendly postcard with natural fibers. Custom printed kraft postcards have a handmade look that is becoming an increasingly popular printing trend.
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="No Coating">None</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Kraft Paper Postcards</h5>
                    <p><strong>Paper Type:</strong>18pt Kraft Paper Stock</p>
                    ...
                    <p><strong>Quantities:</strong> 25 - 1,000</p>
                </div>

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 18pt Kraft Paper Postcards</h5>
