...
<div class="container product-page">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>14pt UV High Gloss Business Cards</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 14pt UV High Gloss Business Cards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 14pt UV High Gloss Business Cards</h5>
