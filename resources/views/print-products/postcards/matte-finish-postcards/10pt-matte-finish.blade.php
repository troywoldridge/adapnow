...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/10pt-matte-finish-postcards.png') }}" class="img-fluid" alt="10pt Matte Finish Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>10pt Matte Finish Postcards</h1>
            <p>Our 10pt Matte Finish Postcards offer a smooth and elegant look, perfect for professional marketing or personal use. These postcards are printed on high-quality paper stock and are a great choice for a variety of purposes.</p>
            ...
            <div class="product-order-box">
                ...
                <form>
                    ...
                    <!-- Scoring Dropdown -->
                    <div class="form-group">
                        <label for="scoring">Scoring</label> <!-- Fixed label id -->
                    ...
                    <!-- Bundling Dropdown -->
                    <div class="form-group">
                        <label for="bundling">Bundling</label> <!-- Fixed label id and option typos -->
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 10pt Matte Finish Postcards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 10pt Matte Finish Postcards</h5>
