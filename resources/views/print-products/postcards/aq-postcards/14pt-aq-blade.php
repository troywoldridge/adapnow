...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/14pt-aq-postcards.png') }}" class="img-fluid" alt="18pt gloss lamination Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>14 pt AQ Postcards</h1>
            <p>Postcards are a powerful and cost-effective marketing tool, particularly useful as a mailer. Value postcards are more economical, but still a very powerful marketing tool.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 10pt AQ Postcards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 14pt AQ Postcards</h5>
