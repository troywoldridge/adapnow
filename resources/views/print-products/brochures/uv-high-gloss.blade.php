...
<div class="container product-page my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>UV High Gloss Brochures</h1>
            <p>Brochures are flyers that are folded. Brochures are compact, allowing you to include more information. These brochures offer a glossy and shiny look that easily grabs attention.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="stock" class="form-control">
                            <option value="Printed-1-Side-(4/0)">Printed 1 Side (4/0)</option>
                            <option value="printed-Both-sides">Printed Both Sides (4/4)</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="uv-high-gloss">UV High Gloss Finish</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="turnaround" class="form-control">
                            <option value="standard">Standard (4-6 Business Days)</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for UV High Gloss Brochures</h5>
                    <p><strong>Paper Type:</strong> High-Quality 100lb Gloss Text</p>
                    <p><strong>Sizes:</strong> 8.5 x 11, 8.5 x 14, 9 x 12, 11 x 17, 17 x 22, 11 x 25.5</p>
                    <p><strong>Coating:</strong> UV High Gloss Finish</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for UV Brochures</h5>
