...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/100lb-matte-finish-flyers.jpg') }}" class="img-fluid" alt="Gloss Text Flyers">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>100lb Matte Finish Flyers</h1>
            <p>Flyers are great marketing tools that can be used to promote products and services. These flyers use our regular semi-gloss stock but do not have any additional gloss coating applied, resulting in a standard matte finish.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Matte Finish Flyers</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 100lb Matte Finish Flyers</h5>
