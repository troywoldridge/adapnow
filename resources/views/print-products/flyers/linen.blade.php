...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/linnen-uncoated-flyers-main.jpg') }}" class="img-fluid" alt="Linen Flyers">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>70lb Linen Uncoated Flyers</h1>
            <p>Flyers are great marketing tools that can be used to promote products and services. These uncoated flyers offer a premium look and a distinctive feel that stand out.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Linen Flyers</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 70lb Linen  Flyers</h5>
