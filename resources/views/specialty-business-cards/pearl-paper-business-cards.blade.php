...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/pearl-paper-business-cards.jpg') }}" class="img-fluid" alt="pearl Paper Business Cards">
        </div>
            ...
            <div class="product-order-box">
                ...
                <form>
                    ...
                    <div class="product-price">
                        <h4>Regular Price:</h4>
                        <p>$21.50</p> <!-- Adjust the price for the specialty card -->
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Pearl Paper Business Cards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>Pearl Paper Business Cards</h5>
