...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/soft-touch-business-cards.png') }}" class="img-fluid" alt="Soft Touch Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>Pearl Paper Business Cards</h1>
            <p>Soft touch business cards are sometimes called suede business cards for their luxurious feel. Soft, matte, velvet-like surface, 19pt thickness, lamination adds protection scratches and smudges.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="matte">Soft Touch Lamination</option>
                        </select>
                    </div>
                    ...
                    <div class="product-price">
                        <h4>Regular Price:</h4>
                        <p>$32.00</p> <!-- Adjust the price for the specialty card -->
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Soft Touch Business Cards</h5>
                    <p><strong>Paper Type:</strong>16pt stock + 3pt lamination</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>Soft Touch Business Cards</h5>
