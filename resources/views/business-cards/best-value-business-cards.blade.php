...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/14pt-writable-aq-business-cards.png') }}" class="img-fluid" alt="Best Value Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>Best ValueBusiness Cards</h1>
            <p>These Wholesale Business Cards offer the best value if you are looking for the most cost effective option or the quickest turnaround.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details Best Value Business Cards</h5>
                    <p><strong>Paper Type:</strong> 14pt Gloss (95 Bright C2S)</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for Best Value Business Cards</h5>
