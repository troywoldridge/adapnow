...
<div class="container product-page my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>Standard UV Presentation Folders</h1>
            <p>Presentation folders are best used as a means to hold documents for organization and presentations.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    ...
                    <p><strong>Quantities</strong>Ranges from 100 to 1000</p>
                    <p><strong>Paper Type:</strong>95 Bright 14pt Gloss C2S Stock</p>
                    <p><strong>Coating:</strong>UV Coating 1 Side Only</p>
                    <p><strong>Printing:</strong> Full-color printing on front and back</p>
                    <p><strong>Finishing:</strong> trim, Die-cut,glue and box</p>
                    <p><strong>SPECIAL INSTRUCTIONS:</strong>The ordered size refers to the finished and folded size of the folders

                        The standard pocket size is 3". An optional 4" pocket is available for 9" x 12" and 9" x 14.5" folders Pocket Types</p>
                </div>

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 14pt UV Folders</h5>
