...
<div class="container product-page my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>Standard Matte Lamination Presentation Folder</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Standard Matte Lamination Folder</h5>
                    ...
                    <p><strong>Coating:</strong>Lamination Finish</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for Standard Matte Laminated Folder</h5>
