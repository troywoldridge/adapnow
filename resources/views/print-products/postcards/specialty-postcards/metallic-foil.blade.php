...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/metallic-foil-postcards-4.png') }}" class="img-fluid" alt="Metallic foil Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>Metallic Foil Postcards</h1>
            <p>Raised foil postcards stand out with their silver or gold custom foil printing. Our wholesale foil printing produces a premium look popular for invitations cards and certificates</p>
            ...
            <div class="product-order-box">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="Foil Color" class="form-control">
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Metallic Postcards</h5>
                    <p><strong>Paper Type:</strong>16pt + 2pt Laminated Stock</p>
                    <p><strong>Sizes:</strong>4x6  8.5x3.5  5x7  4x9  8.5x5.5</p>
                    <p><strong>Foil Color:</strong>Gold or Silver</p>
                    <p><strong>Finishing:</strong> Cut to size and boxed</p>
                    <p><strong>Quantities:</strong> 100 - 1,000</p>
                </div>

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 14pt Metallic Foil Postcards</h5>
