...
<div class="container product-page my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>18pt Gloss Lamination Postcards</h1>
            <p>Postcards are a powerful and cost-effective marketing tool, particularly useful as a mailer. Postcards with a glossy and shiny lamination. They offer better durability.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 18pt Gloss Lamination Finish Postcards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 18pt Gloss Lamination Postcards</h5>
