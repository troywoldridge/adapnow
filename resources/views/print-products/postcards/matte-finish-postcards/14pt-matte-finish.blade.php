...
<div class="container product-page my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>14pt Matte Finish Postcards</h1>
            <p>Our 14pt Matte Finish Postcards offer a smooth and elegant look, perfect for professional marketing or personal use. These postcards are printed on high-quality paper stock and are a great choice for a variety of purposes.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 14pt Matte Finish Postcards</h5>
