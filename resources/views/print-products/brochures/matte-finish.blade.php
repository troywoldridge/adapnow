...
<div class="container product-page my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>Matte Finish Brochures</h1>
            <p>Brochures are flyers that are folded. Brochures are compact, allowing you to include more information. These brochures offer a silky, smooth and elegant finish.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="gloss-text">Matte Finish</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Matte Finish Brochures</h5>
                    ...
                    <p><strong>Quantities:</strong> 100 to 100,000</p>
                </div>

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for Matte Finish Brochures</h5>
