...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/16pt-aq-business-cards.png') }}" class="img-fluid" alt="14pt AQ Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>16pt AQ Business Cards</h1>
            <p>Our 16pt Business cards with AQ have a semi-gloss look and are the most commonly ordered.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="size" class="form-control">
                            ...
                            <option value="3.5x1.75">3.5 x 1.75 inches</option>
                            <option value="3.5x1.5">3.5 x 1.5 inches</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="matte">Gloss Lamination</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 16pt AQ Business Cards</h5>
                    <p><strong>Paper Type:</strong> 95 Bright 14pt C2S Stock</p>
                    <p><strong>Sizes:</strong> 3.5" x 2", 3.5" x 1.75", 3.5" x 1.5"</p>
                    <p><strong>Coating:</strong>AQ Coating</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 16pt AQ Business Cards</h5>
