...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/13pt-enviro-uncoated-postcards.png') }}" class="img-fluid" alt="18pt gloss lamination Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>13pt Enviro Postcards</h1>
            <p>Postcards are a powerful and cost-effective marketing tool, particularly useful as a mailer. These postcards contain 30% post consumer recycled material, making them a more environmentally friendly option.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 13pt Enviro Postcards</h5>
                    <p><strong>Paper Type:</strong> 13pt Enviro Stock(Contains 30% post consumer rycled material)</p>
                    ...
                    <p><strong>Quantities:</strong> 25 - 90,000</p>
                </div>

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 13pt  Enviro Postcards</h5>
