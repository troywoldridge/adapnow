...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/14pt-matte-business-cards.png') }}" class="img-fluid" alt="14pt Matte Finish Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>14pt Matte Finish Business Cards</h1>
            <p>Our 14pt matte finish business cards offer a smooth, elegant look.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 14pt Matte Finish Business Cards</h5>
