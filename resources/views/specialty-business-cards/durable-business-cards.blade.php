...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/durable-business-cards-3.png') }}" class="img-fluid" alt="Durable Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>Durable Business Cards</h1>
            <p>Through the use of a high quality substrate, this synthetic paper is perfect for customized and short run designs. Sourced from raw material, it is 100% recyclable, non-toxic, and extremely durable. The waterproof and tear resistant qualities guarantee that your business cards will always look great, even in the most adverse of conditions.</p>
            ...
            <div class="product-order-box">
                ...
                <form>
                    ...
                    <div class="product-price">
                        <h4>Regular Price:</h4>
                        <p>$27.50</p> <!-- Adjust the price for the specialty card -->
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Durable Business Cards</h5>
                    <p><strong>Paper Type:</strong> 16pt Tear / Waterproof Stock</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for Durable Business Cards</h5>
