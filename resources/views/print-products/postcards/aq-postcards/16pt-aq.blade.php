...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/16pt-aq-postcards.png') }}" class="img-fluid" alt="18pt gloss lamination Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>16 pt AQ Postcards</h1>
            <p>Postcards are a powerful and cost-effective marketing tool, particularly useful as a mailer. These semi-gloss postcards are a good option for those seeking thicker cards.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="size" class="form-control">
                            ...
                            <option value="5.5x2.125">5.5 x 2.125</option>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 16pt AQ Postcards</h5>
                    <p><strong>Paper Type:</strong> 14pt 95 Bright C2S Stock</p>
                    ...
                    <p><strong>Quantities:</strong> 100 - 90,000</p>
                </div>

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 16pt AQ Postcards</h5>
