...
<div class="container product-page">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p>These business cards have a glossy and shiny lamination which also offers better durability.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 18pt Gloss Lamination Business Cards</h5>
