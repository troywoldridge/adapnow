...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/18pt-gloss-lamination-business-cards.png') }}" class="img-fluid" alt="18pt Gloss Lamination Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>16pt UV High Gloss Business Cards</h1>
            <p>Business cards are widely used as a networking tool and a way to make a good first impression. Our 16pt Business cards with UV coating have a very glossy and shiny look on a thicker stock.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="matte">High Gloss UV Coating</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 16pt UV High Gloss Business Cards</h5>
                    <p><strong>Paper Type:</strong> 95 Bright 16pt C2S Stock</p>
                    <p><strong>Sizes:</strong> 3.5" x 2"</p>
                    <p><strong>Coating:</strong> High Gloss UV Coating</p> <!-- Changed to High Gloss UV Coating -->
                    <p><strong>Finishing:</strong> Cut to size and boxed</p>
                    <p><strong>Quantities:</strong> 100 - 25,000</p>
                    <p><strong>Rounded Corners:</strong> 1/4 radius available</p>
                </div>
                

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 16pt UV High Gloss Business Cards</h5>
                ...
                <div class="tab-pane fade" id="reviews" role="tabpanel">
                    ...
                    <p>★★★★★ "Great quality, fast turnaround!"</p>
                    <p>★★★★ "Good product but shipping could be improved."</p>
                </div>
            </div>
        </div>
    </div>
