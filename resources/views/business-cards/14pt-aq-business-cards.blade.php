...
<div class="container product-page">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1>14pt AQ Business Cards</h1>
            <p>Our 14pt Business cards with AQ have a semi-gloss look and are the most commonly ordered.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 14pt AQ Business Cards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 14pt AQ Business Cards</h5>
