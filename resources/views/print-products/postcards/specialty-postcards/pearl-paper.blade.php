...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/pearl-paper-postcards.png') }}" class="img-fluid" alt="Spot UV Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>Pearl Paper Postcards</h1>
            <p>Pearl paper stock has a smooth, metallic shine due to the iridescent fibers infused into the pearl paper. Often referred to as pearl shimmer paper, this stock has a unique aesthetic appeal along with its distinct texture.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Pearl Paper Postcards</h5>
                    <p><strong>Paper Type:</strong>Pearlescents 110lb</p>
                    <p><strong>Sizes:</strong>4x6  8.5x3.5  5x7  8.5x5.5</p>
                    <p><strong>Coating:</strong>Spot UV 1 Side</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for Pearl Paper Postcards</h5>
