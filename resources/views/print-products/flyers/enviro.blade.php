...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/enviro-uncoated-flyers-main.jpg') }}" class="img-fluid" alt="Enviro Flyers">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>80lb Enviro Uncoated Flyers</h1>
            <p>Flyers are great marketing tools that can be used to promote products and services. These flyers contain 100% post consumer recycled material, making them a more environmentally friendly option.</p>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="Coating" class="form-control">
                            <option value="Matte Finish">No Coating</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Enviro Flyers</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 80lb Enviro Uncoated Flyers</h5>
