...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/13pt-linen-uncoated-postcards.png') }}" class="img-fluid" alt="18pt gloss lamination Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>13pt Linen Postcards</h1>
            <p>Postcards are a powerful and cost-effective marketing tool, particularly useful as a mailer. Linen postcards offer a premium look and a distinctive feel that stand out.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 13pt Linen Postcards</h5>
                    <p><strong>Paper Type:</strong> 13pt Enviro Stock(Contains 30% post consumer recycled material)</p>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 13pt  Linen Postcards</h5>
