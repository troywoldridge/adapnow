...
<div class="container product-page">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/14pt-matte-business-cards.png') }}" class="img-fluid" alt="16pt Matte Finish Business Cards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>16pt Matte Finish Business Cards</h1>
            <p>Our 16pt matte finish business cards are a good option for those seeking thicker stock.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for 14pt Matte Finish Business Cards</h5>
                ...
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for 16pt Matte Finish Business Cards</h5>
