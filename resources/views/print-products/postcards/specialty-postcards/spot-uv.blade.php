...
<div class="container product-page my-5">
    <div class="row">
        <!-- Product Image -->
        <div class="col-md-6">
            <img src="{{ asset('images/all-images/spot-uv-postcards.png') }}" class="img-fluid" alt="Spot UV Postcards">
        </div>

        <!-- Product Details and Order Form -->
        <div class="col-md-6">
            <h1>Matte Lamination + Spot UV</h1>
            <p>Print laminated postcards with raised spot gloss for a premium marketing tool.
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select id="coating" class="form-control">
                            <option value="No Coating">Spot UV on 1 Side</option>
                        </select>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="productTabContent">
                ...
                <div class="tab-pane fade show active" id="details" role="tabpanel">
                    <h5>Product Details for Matte Lamination + Spot UV Postcards</h5>
                    <p><strong>Paper Type:</strong>16pt C2S Stock with matte lamination</p>
                    ...
                    <p><strong>Quantities:</strong> 500 - 2,500</p>
                </div>

                <!-- File Prep Tab -->
                <div class="tab-pane fade" id="fileprep" role="tabpanel">
                    <h5>File Prep for Matte Lamination + Spot UV Postcards</h5>
